...
class OnlineReaderSystem {
	...
	public Book getActiveBook(User user) {
		return activeUsers.get(user.getId()).getUserLib().find(user.getActiveBookId());
	}
	...
	/*
	 * public User getActiveUser(int user_id) { return activeUsers.get(user_id); }
	 */
...
/*
 * We then implement separate classes to handle the user manager, the library,
 * and the display components
 */

/*
 * This class represents the Library which is responsible for storing and
 * searching the books.
 */
class Library {
...
/*
 * This class represents the UserManager which is responsible for managing the
 * users, their membership etc.
 */
...
/*
 * This class represents the Display, which is responsible for displaying the
 * book, it's pages and contents. It also shows the current user. It provides
 * the method turnPageForward, turnPageBackward, refreshPage etc.
 */
...
class Display {
	...
	public void turnPageForward() {
		...
		System.out
				.println("Turning forward to page no " + pageNumber + " of book having title " + activeBook.getTitle());
		refreshPage();
	}
	...
	public void turnPageBackward() {
		...
		activeUser.getUserLib().find(activeBook.getId()).setPageNum(pageNumber);
		System.out.println(
				"Turning backward to page no " + pageNumber + " of book having title " + activeBook.getTitle());
		refreshPage();
	}
...
/*
 * The classes for User and Book simply hold data and provide little
 * functionality.
 */
