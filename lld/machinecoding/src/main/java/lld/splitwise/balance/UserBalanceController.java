...
public class UserBalanceController {
	static final Map<String, UserBalance> userFinalBalanceMap = new HashMap<String, UserBalance>();
	...
	public void updateUserBalance(ExpenseSplit expenseSplit, User payer, double expenseAmount) {
		...
		UserBalance userBalance = userFinalBalanceMap.getOrDefault(userId, new UserBalance(expenseSplit.getUser()));
