 ...
 */
public class traversalInA2DArray {
	...
	public static boolean isSafe(char[][] a, int i, int j, int n, int m) {
		return i <= n - 1 && j <= m - 1 && a[i][j] != 'x';
	}

	public static void main(String args[]) {
		char arr[][] = { { '0', '0', '0', '0' }, { 'x', 'x', '0', '0' }, { '0', 'x', '0', '0' } };

		System.out.println(totalWays(0, 0, arr, 3, 4));
	}
